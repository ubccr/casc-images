Ext.onReady(function(){
    ...
    var casc_members = new Ext.data.ArrayStore({
        ...
        [65, 'Research Technologies, Stony Brook University'],
        [66, 'San Diego Supercomputer Center (SDSC), University of California, San Diego'],
        [67, 'Scientific Computation Research Center (SCOREC), Rensselaer Polytechnic Institute'],
        [68, 'Shared Research Computing Center, Florida State University'],
        [69, 'Stanford University, Stanford'],
        [70, 'Supercomputing Center for Education and Research, University of Oklahoma'],
        [71, 'Texas Advanced Computing Center (TACC), The University of Texas at Austin'],
        [72, 'The Pennsylvania State University, University Park'],
        [73, 'University of Colorado Boulder, Boulder'],
        [74, 'University of Connecticut, Storrs'],
        [75, 'University of Florida, Gainesville'],
        [76, 'University of Iowa, Iowa City'],
        [77, 'University of Louisville, Louisville'],
        [78, 'University of Maryland, College Park'],
        [79, 'University of Massachusetts, Shrewsbury'],
        [80, 'University of Miami, Miami'],
        [81, 'University of North Carolina, Chapel Hill, Chapel Hill'],
        [82, 'University of Rhode Island, Kingston'],
        [83, 'University of South Florida, Tampa'],
        [84, 'Vanderbilt University, Knoxville'],
        [85, 'West Virginia University, Morgantown'],
        [86, 'Yale University, New Haven']
        ]
    });
