Ext.onReady(function(){
    ...
    var casc_members = new Ext.data.ArrayStore({
        ...
        [38, 'Institute for Massively Parallel Applications, The George Washington University'],
        ...
        [44, 'Medical Center Information Technology, New York University Langone Medical Center'],
        [45, 'Michigan Technical Institute, Houghton'],
        [46, 'Minnesota Supercomputing Institute, University of Minnesota'],
        [47, 'Montana State University, Bozeman'],
        [48, 'National Center for Atmospheric Research (NCAR), Boulder'],
        [49, 'National Center for Supercomputing Applications (NCSA), University of Illinois at Urbana-Champaign'],
        [50, 'National Institute for Computational Sciences (NICS), University of Tennessee'],
        [51, 'National Supercomputing Center for Energy & the Environment (NSCEE), University of Nevada'],
        [52, 'New York University, New York'],
        [53, 'Northwestern University, Evanston'],
        [54, 'Oak Ridge National Laboratory (ORNL) Center for Computational Sciences, Oak Ridge'],
        [55, 'Ohio Supercomputer Center (OSC), The Ohio State University'],
        [56, 'Old Dominion University, Norfolk'],
        [57, 'Pittsburgh Supercomputing Center, Carnegie-Mellon University & University of Pittsburgh'],
        [58, 'Princeton University, Princeton'],
        [59, 'Purdue University, West Lafayette'],
        [60, 'Renaissance Computing Institute (RENCI), University of North Carolina at Chapel Hill'],
        [61, 'Research Computing Center, Columbia University'],
        [62, 'Research Computing Center, University of Arizona'],
        [63, 'Research Computing Center, University of Illinois, Chicago'],
        [64, 'Research Computing Center, University of New Hampshire'],
        [65, 'Research Cyberinfrastructure Center, University of California, Irvine'],
        [66, 'Research Technologies, Stony Brook University'],
        [67, 'San Diego Supercomputer Center (SDSC), University of California, San Diego'],
        [68, 'Scientific Computation Research Center (SCOREC), Rensselaer Polytechnic Institute'],
        [69, 'Shared Research Computing Center, Florida State University'],
        [70, 'Stanford University, Stanford'],
        [71, 'Supercomputing Center for Education and Research, University of Oklahoma'],
        [72, 'Texas Advanced Computing Center (TACC), The University of Texas at Austin'],
        [73, 'The Pennsylvania State University, University Park'],
        [74, 'The University of Alabama at Birmingham, Birmingham'],
        [75, 'University of Colorado Boulder, Boulder'],
        [76, 'University of Connecticut, Storrs'],
        [77, 'University of Florida, Gainesville'],
        [78, 'University of Iowa, Iowa City'],
        [79, 'University of Louisville, Louisville'],
        [80, 'University of Maryland, College Park'],
        [81, 'University of Massachusetts, Shrewsbury'],
        [82, 'University of Miami, Miami'],
        [83, 'University of North Carolina, Chapel Hill, Chapel Hill'],
        [84, 'University of Rhode Island, Kingston'],
        [85, 'University of South Florida, Tampa'],
        [86, 'Vanderbilt University, Knoxville'],
        [87, 'West Virginia University, Morgantown'],
        [88, 'Yale University, New Haven']
        ]
    });
